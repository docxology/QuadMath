...
surfaces — lattice enumeration (``ivm_field.ball_sites``), Laplacian-
regularized field learning (:meth:`IVMField.learn`), and discrete lattice
dynamics (:func:`ivm_dynamics.simulate`) — without modifying them.
...
Examples
--------
>>> from pipeline import Pipeline, sites_step, learn_step
