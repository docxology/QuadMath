"""Tests for lattice training/testing methodology (src/learning_eval.py).
...
from ivm_dynamics import DynamicsParams, make_lattice, simulate, step
...
from quadray import DEFAULT_EMBEDDING, Quadray
