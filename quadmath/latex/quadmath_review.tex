...
\includegraphics{../output/ivm_neighbors_edges.png}
\includegraphics{../output/quadray_clouds.png}
\includegraphics{../output/vector_equilibrium_panels.png}
...
\tightlist
\item
  \textbf{Figures referenced}: In-text carry identifiers (e.g., Fig.
