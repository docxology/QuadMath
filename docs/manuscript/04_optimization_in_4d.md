...
The methods above complement the computational framework in Kirby Urner's [4dsolutions ecosystem](https://github.com/4dsolutions); implementation and educational context are collected in the [Resources](99_resources.md) section.
