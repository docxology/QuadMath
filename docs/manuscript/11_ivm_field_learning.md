...
![Static IVM field learning on the IVM lattice ball of radius 3: synthetic field (left), noisy observations at half the sites (center), and the learned field (right) with reconstruction MSE 0.0558 against observation noise MSE 0.0720.](figures/ivm_field_demo.png)
